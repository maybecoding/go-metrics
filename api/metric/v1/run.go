...
func (s *Service) Run(ctx context.Context) error {
	...
	if err != nil {
		return fmt.Errorf("metricv1 - Run - net.Listen: %w", err)
	}
	...
	if s.cfg.CryptoKey != "" {
		...
		if err != nil {
			return fmt.Errorf("metricv1 - Run -NewServerTLSFromFile: %w", err)
		}
	...
	if err = s.grpcS.Serve(listen); err != nil {
		return fmt.Errorf("metricv1 - Run - grpcS.Serve: %w", err)
	}
